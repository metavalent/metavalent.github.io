...
> What is this FOR? It's for playing with the so-called Fabric Of Reality (FOR) as artistic medium. It's for exploring how diverse FORs interdependently, recursively, revise and co-contruct our WHY's and HOW's; and even manifest as our WHO's, WHAT's, WHEN's, and WHERE's. It's for being curious about how our individual and shared Theories Of Everything (TOEs) are woven from such a tiny set of common initial conditions; not just in the form of tiny threads of DNA, but perhaps even emerging from a single initial condition, field, or substrate of wholeness.
